...
hi WarningMsg guifg=#FF6B6B guibg=NONE
hi PreProc guifg=#FF6B6B guibg=NONE
hi Exception guifg=#FF6B6B guibg=NONE
hi Error guifg=#FF6B6B guibg=NONE
hi DiffDelete guifg=#FF6B6B guibg=NONE
hi GitGutterDelete guifg=#FF6B6B guibg=NONE
hi GitGutterChangeDelete guifg=#FF6B6B guibg=NONE
hi cssIdentifier guifg=#FF6B6B guibg=NONE
hi cssImportant guifg=#FF6B6B guibg=NONE
hi Type guifg=#FF6B6B guibg=NONE
hi Identifier guifg=#FF6B6B guibg=NONE
hi PMenuSel guifg=#2CF6B3 guibg=NONE
hi Constant guifg=#2CF6B3 guibg=NONE
hi Repeat guifg=#2CF6B3 guibg=NONE
hi DiffAdd guifg=#2CF6B3 guibg=NONE
hi GitGutterAdd guifg=#2CF6B3 guibg=NONE
hi cssIncludeKeyword guifg=#2CF6B3 guibg=NONE
hi IncSearch guifg=#FFE66D guibg=NONE
...
hi Todo guifg=#FFE66D guibg=NONE
hi Special guifg=#FFE66D guibg=NONE
hi Label guifg=#FFE66D guibg=NONE
...
hi MatchParen guifg=#FFE66D guibg=NONE
hi Macro guifg=#FFE66D guibg=NONE
hi DiffChange guifg=#FFE66D guibg=NONE
...
hi cssAttr guifg=#4ECDC4 guibg=NONE
